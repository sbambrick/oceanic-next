...
" {{{ Setup
  ...
  let g:colors_name="OceanicNextDim"
" }}}
" {{{ Italics
...
"}}}
" {{{ Colors
  let s:base00=['#111c22', '235']
  let s:base01=['#576675', '237']
  let s:base02=['#4f5b66', '240']
  let s:base03=['#6f8090', '243']
  let s:base04=['#7e879a', '145']
  let s:base05=['#9aa2b1', '251']
  let s:base06=['#a3aec2', '252']
  let s:base07=['#adbad1', '253']
  let s:base08=['#f4a4a8', '203']
  let s:base09=['#fbbe9d', '209']
  let s:base0A=['#fcdc9c', '221']
  let s:base0B=['#bfdcbc', '114']
  let s:base0C=['#98cdcc', '73']
  let s:base0D=['#9fbfdf', '68']
  let s:base0E=['#dbbddb', '176']
  let s:base0F=['#c9a89c', '137']
  let s:base10=['#d9d9d9', '15']
